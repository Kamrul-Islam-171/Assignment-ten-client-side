    ...
    return (
        <div className='h-[420px]'>
            <Swiper pagination={true} loop={true} modules={[Pagination, Autoplay]} className="mySwiper" autoplay={{
                ...
                <SwiperSlide>
                    <div className='flex flex-col items-center space-y-4 bg-gray-800 text-white h-[420px] justify-center'>
                        ...
                        <h1 className = 'text-xl font-medium'>Samantha Lee</h1>
                ...
                <SwiperSlide>
                    <div className='flex flex-col items-center space-y-4 bg-gray-800 text-white h-[420px] justify-center'>
                        ...
                        <h1 className = 'text-xl font-medium'>Michael Nguyen</h1>
                        <h3 className=''>Chief Operations Officer</h3>
                ...
                <SwiperSlide>
                    <div className='flex flex-col items-center space-y-4 bg-gray-800 text-white h-[420px] justify-center'>
                        ...
                        <h1 className = 'text-xl font-medium'>Emily Patel</h1>
                        <h3 className=''>Head of Customer Experience</h3>
                        <p className='w-[90%] text-center'>Emily is dedicated to providing exceptional customer service and ensuring that every traveler's journey with Tourista is nothing short of extraordinary. She goes above and beyond to address customer needs, resolve issues, and exceed expectations at every touchpoint.</p>
                    </div>
                ...
                <SwiperSlide>
                    <div className='flex flex-col items-center space-y-4 bg-gray-800 text-white h-[420px] justify-center'>
                        ...
                        <h1 className = 'text-xl font-medium'>David Chen</h1>
                        <h3 className=''>Technology Director</h3>
