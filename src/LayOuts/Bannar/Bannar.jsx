                ...
                <SwiperSlide>
                    ...
                    <div className="h-[calc(100vh-80px)] bg-gradient-to-tr from-[#000000CC] to-[#00000059]" >
                        ...
                        <div className=' absolute top-1/3 md:left-1/4 lg:left-1/4 left-10 space-y-4'>
                            ...
                            >Bandarban</h1>
                            <p className='text-white w-[90%] md:w-4/5 lg:w-3/4'> Bandarban's unparalleled beauty, cultural diversity, adventure opportunities, and tranquil ambiance make it a must-visit destination for travelers seeking an authentic and immersive experience in Bangladesh.</p>
                        </div>
                ...
                <SwiperSlide>
                    <div className="h-[calc(100vh-80px)] bg-gradient-to-tr from-[#000000CC] to-[#00000059]">
                        ...
                        <div className='space-y-4 absolute top-1/3 md:left-1/4 lg:left-1/4 left-10'>
                            ...
                            <p className='text-white w-[90%] md:w-4/5 lg:w-3/4'>Cameron Highlands offers a delightful blend of natural beauty, outdoor adventures, cultural experiences, and culinary delights, making it a must-visit destination for travelers exploring Malaysia.</p>
                        </div>
                ...
                <SwiperSlide>
                    <div className="h-[calc(100vh-80px)] bg-gradient-to-tr from-[#000000CC] to-[#00000059]">
                        ...
                        <div className='space-y-4  absolute top-1/3 md:left-1/4 lg:left-1/4 left-10'>
                            ...
                            <p className='text-white w-[90%] md:w-4/5 lg:w-3/4'> Explore hidden caves, secluded beaches, and floating fishing villages aboard traditional wooden boats. Witness stunning sunsets and sunrises that paint the sky with vibrant colors, casting a magical spell over the tranquil waters.</p>
                        </div>
