            ...
            <div className="container mx-auto pb-3 ">
                <div className='text-white pt-20 text-center lg:text-start  grid gap-5 lg:grid-cols-4 md:grid-cols-2 '>
                    <div className="">
                        ...
                        <h1 className='text-gray-100 text-2xl font-bold'>Tourista</h1>
                        <p className='text-gray-400'>Explore the world with us and create unforgettable travel memories.Your gateway to extraordinary destinations and immersive experiences.</p>
                    </div>
                    <div className="lg:ml-10">
                        ...
                        <p className="text-gray-400">All Tourist Spots</p>
