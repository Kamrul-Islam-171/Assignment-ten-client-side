        ...
        <div className="">
            ...
            <div className="bg-gray-700 text-white h-screen flex items-center">
                <div className="container  mx-auto grid lg:grid-cols-2 md:grid-cols-2 md:px-10 gap-5 items-center lg:px-16">
                    {/* Our history */}
                    <h1 className="text-6xl">Our History</h1>
                    <p className="text-xl">Tourista was founded with a simple yet ambitious goal: to make travel in Southeast Asia accessible, affordable, and unforgettable for everyone. Since our inception 2016, we have grown from a small startup into a trusted authority in the travel industry. Along the way, we've overcome challenges, celebrated successes, and forged lasting partnerships with local businesses and communities across the region.</p>
                </div>
            </div>

            <div className="grid lg:grid-cols-3 gap-5  container mx-auto mt-16">
                {/* mission */}
                <div className="border-2 lg:p-10 p-2 md:p-5 flex flex-col justify-center items-center text-center space-y-5">
                ...
                {/* vission */}
                <div className="border-2 lg:p-10 p-2 md:p-5 text-center space-y-5 flex flex-col justify-center items-center ">
            ...
            <div className="flex lg:flex-row flex-col gap-20 md:flex-row container mx-auto mt-16">
                <div className="flex flex-col items-center justify-center space-y-4">
                    <h1 className="lg:text-5xl md:text-4xl text-2xl">Meet Our Team Members</h1>
                    <p className="text-center">Meet the passionate individuals who make Tourista possible. Our team is comprised of experienced travel experts, destination specialists, and customer service professionals who share a common love for Southeast Asia.</p>
                </div>
            ...
            <h1 className="text-center text-5xl mt-20 mb-10">Out Commitments</h1>
            <div className=" grid lg:grid-cols-4 md:grid-cols-2 container mx-auto gap-5 mb-10">
                {/* Our Commitments */}
                <div className="border-2 p-5  text-center space-y-4">
